...
\begin{document}
	...
	\chapter{La dépendance causale}
		...
		Imaginons une configuration impliquant trois personnes : Paul, sa femme Laure, et leur fille Lisa. Comparons deux événements : \og{}Paul demande le divorce\fg{} et \og{}Paul donne un peu d'argent à Lisa pour s'acheter une boisson fraîche\fg{}. 
		
		Dans une ontologie strictement plate, ces deux événements semblent de même nature : ils constituent l'un comme l'autre une simple création ou suppression locale de liens. Pourtant, nous percevons intuitivement qu'ils ne sont pas équivalents quant à leurs conséquences. 
		
		Pour caractériser objectivement le fait qu'un lien soit plus \og{}structurant\fg{} qu'un autre sans recourir à un jugement de valeur externe, nous pouvons évaluer le \og{}poids topologique\fg{} de l'événement qui le modifie. Deux mesures, intimement liées, s'offrent à nous : 
		\begin{enumerate}
