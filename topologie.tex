...
\begin{document}
	...
	\section{L'acteur agit avec une vision partielle du système} 
	...
	\section{Les modélisations possibles pour l'observateur}
	
	Dès lors qu'un observateur utilise un modèle du système, il dispose d'un attirail théorique conséquent : probabilités, référentiel, etc. Nous insistons cependant sur la part de subjectivité de ces méthodes, incompatibles avec une solution ontologique. 
