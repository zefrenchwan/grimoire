...
\begin{document}
	...
	\chapter{Les propriétés de l'ontologie de base}
		...
		\section{L'émergence}
			...
			On ne peut exiger moins : sans voiture, pas d'embouteillage. C'est la présence des voitures dans leur globalité qui créé le phénomène mais ce n'est pas dépendant de la présence de telle ou telle voiture. Ce n'est pas l'identité des composants qui explique le phénomène, ni les composants pris isolément. 
